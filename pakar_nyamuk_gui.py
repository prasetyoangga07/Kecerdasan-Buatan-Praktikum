...
prolog = Prolog()
prolog.consult("pakar_nyamuk_gui.pl")
...
root = tk.Tk()
root.title("Sistem Pakar Diagnosis Penyakit Akibat Gigitan Nyamuk")
...
ttk.Label(mainframe, text="Aplikasi Diagnosa Penyakit Akibat Gigitan Nyamuk", font=("Arial", 16)).grid(column=0, row=0, columnspan=3)
